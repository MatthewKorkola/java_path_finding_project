...
public class TestStack {
	...
	public static void main(String[] args) {
		...
		if (sStack.size() == 5 && sStack.getLength() == 10 && sStack.getTop() == 4) {
		...
		if (res1.equals("Kiwi") && res2.equals("Kiwi") && res3.equals("Strawberry") && res4.equals("Strawberry") && sStack.size() == 3 && sStack.getTop() == 6) {
