...
public class CellColours {
	...
	public static final Color DONUT = new Color(195, 1, 1);
	public static final Color DONUT_PUSHED = new Color(195, 1, 2);
	public static final Color DONUT_POPPED = new Color(195, 2, 1);
	public static final Color EXIT = new Color(255, 1, 1);
	public static final Color EXIT_PUSHED = new Color(255, 1, 2);
	public static final Color EXIT_POPPED = new Color(255, 2, 1);
	public static final Color COVID = Color.YELLOW;
